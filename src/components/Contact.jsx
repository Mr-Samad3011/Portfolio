...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="w-full min-h-screen px-6 py-16 bg-gray-950 dark:bg-gray-950"
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        <form
          ...
          className="space-y-6 text-left bg-gray-900 dark:bg-gray-900 p-8 rounded-lg shadow-md"
        >
          <div>
            ...
            <input
              ...
              className="w-full p-3 rounded bg-gray-700 border border-blue-700 text-white"
              required
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-gray-600 text-white py-3 rounded hover:bg-blue-700 transition disabled:opacity-50"
            disabled={isSending}
          >
